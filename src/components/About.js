...
//   }
  ...
  <div className="accordion-item">
    ...
    <div id="collapseOne" className='accordion-collapse collapse show' data-bs-parent="#accordionExample">
     ...
     TextUtils gives you a way to analyze your text quickly and eddiciently. Be it word count,character count,reading time etc.
      </div>
    </div>
  </div>
  <div className='accordion-item'>
    ...
    <div id="collapseTwo" className='accordion-collapse collapse' data-bs-parent="#accordionExample">
      ...
      TextUtils is a free character tool that provides instant character count and word count statistics for a given text.TextUtils reports the number of words and characters.Thus it is suitable for waiting text with word/character limit.
      </div>
    </div>
  </div>
  <div className='accordion-item'>
